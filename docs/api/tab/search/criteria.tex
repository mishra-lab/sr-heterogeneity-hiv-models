...
\begin{tabular}{L{.45}L{.49}}
	...
	\midrule
	\multicolumn{2}{l}{\textbf{Context \& Research Questions}}                                                              \\
	\midrule
	\tabitem any region in Sub-Saharan Africa (SSA)\tn{4}   & \tabitem only regions outside SSA modelled                    \\
	\tabitem assess prevention impact of ART scale-up\tn{5} & \tabitem only theoretical context modelled                    \\
	                                                        ...
	                                                        & \tabitem only ART targeted to some risk groups\tn{*}          \\
	                                                        & \tabitem ART prevention benefits not reported\tn{5*}          \\
	\bottomrule
\end{tabular}
\floatfoot{
  ...
  \tnt[*]{Used to defined Dataset~B only.}
}
