...
Of note, zero scenarios had considered lower ART coverage among key populations. %SM: correct? I think if correct, we should include in abstract as that is a key finding.
\textbf{Conclusion.}
Among compartmental transmission models applied to project ART prevention impacts in Sub-Saharan Africa,
representations of risk heterogeneity and projected impacts varied considerably. The inclusion/exclusion of risk heterogeneity and turnover, and intervention heterogeneity across risk groups could influence the projected impact of ART scale-up. %SM: if dont' have risk  heterogenetiy -  how can we have interevention heterogeneity? 
