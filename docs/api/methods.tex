...
\par
We conducted an ecological analyses across all modelled scenarios to examine the relationship between  %SM: make it super explicit and clear what the focus of the research question is and why focusing on risk heterogeneity (as per the rationale provided in the introduction).
factors of risk heterogenetiy and projected ART impacts, after adjusting for other factors that could influence modelled outcomes.
For each factor of risk heterogeneity, we compared projected ART impacts (incidence reduction/infections averted)
