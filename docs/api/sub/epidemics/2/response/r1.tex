...
This semi-parametric model allows estimation of population-averaged effects of each factor on the outcome, %SM: nicely phrased and excellent re: providing rationale in response letter
...
women and men engaged in sex work, and men who have sex with men [Hakim2018, Nyato2019].
Data suggest other sub-populations, including youth and men who have sex with women, may also  %SM: moving away from term "heterosexual" in updated guidance
experience barriers to engagement in ART care [Green2020, Quinn2019]
that could undermine treatment as prevention.}
Additionally, the ``sex/gender'' stratification variable for objective 3 %SM: strictly speaking then you are talkinig about gender not sex. sex is a biological variable. engagement in care reflects gender not biology (see CIHR guidance on sex/gender-based analysis).
...
we did not seek to explore or explain all covariate effects from the model, as per best practices in analsyes of secondary data when the focus is on the primary exposure variables of interest. %SM: refer to table 2 fallacy
Finally, we added the following to the limitations paragraph:
\quote{Third, we did not extract data on model fitting, %SM: I don't follow ... what do we mean extract data on model fitting? did not examine how models were calibrated or what the calibration targets were? or...?
