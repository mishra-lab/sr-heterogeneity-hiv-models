...
\quote{Risk heterogeneity can be defined by various factors affecting acquisition and onward transmission risk,
and is a well-established determinant of the emergence and persistence of HIV epidemics [Anderson1986,Boily1997].
Systematic model comparison studies by Hontelez et al (2013) and Rozhnova et al (2016)
...
experience barriers to engagement in ART care [Arnesen2017,Chikwari2018,Quinn2019].}
...
as per best practices in analyses of secondary data when the focus is on the primary exposure variables of interest
--- i.e. doing so could lead ``table 2 fallacy''.
Finally, we added the following to the limitations paragraph:
\quote{Third, we did not extract whether models were calibrated,
