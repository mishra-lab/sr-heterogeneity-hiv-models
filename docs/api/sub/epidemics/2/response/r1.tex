...
% SM: I don't follow ... what do we mean extract data on model fitting? did not examine how models were calibrated or what the calibration targets were? or...?
% JK: We really didn't extract any of that, but as it relates to effect estimates (and so worth mentioning here), I've revised above to hopfeully be more clear?
