...
The number of groups defined by sex and/or activity was \xdm{act/act.n}  (Figure~\ref{fig:act.n});
...
greater ART eligibility (\ref{fig:api:art.cd4});
however patterns were not consistent across
HIV incidence trajectory (\ref{fig:api:api.phase}),
ART coverage targets (\ref{fig:api:art.cov}), or
relative infectiousness on ART (\ref{fig:api:art.rbeta}).
