\def\na{94\xspace}
\def\ni{40\xspace}
Database search identified 1384 publications,
of which \na articles met the inclusion criteria
(Figure~\ref{fig:prisma}).
Among 360 articles using dynamical HIV transmission models applied to SSA,
255 were compartmental models, of which
\na were applied simulate ART scale-up (Database~A), of which
...
% Southern Africa was the most represented SSA region being simulated in xx articles,
...
high-prevalence epidemics (${>10\%}$ HIV prevalence, \x{t0/n.prev.High} articles) or
...
all three criteria were satisfied in \x{kp/n.FSW.n.crit.3} articles;
...
\label{sss:res:beh}
Reduced sexual activity due to late-stage HIV symptoms was simulated in \x{hiv/n.hiv.morb.any} articles,
including at least one state with:
complete withdrawal from sexual activity (\x{hiv/n.hiv.morb.inact});
reduced rate of partnership formation (\x{hiv/n.hiv.morb.np}); and/or
reduced rate of coital frequency (\x{hiv/n.hiv.morb.vol}).
\par
...
was simulated in \x{art/n.bc.any} articles, including:
increased condom use (\x{art/n.bc.cond.any});
fewer partners per year (\x{art/n.dx.bc.np});
less sex per partnership (\x{art/n.dx.bc.vol});
serosorting\cite{} (\x{art/n.dx.bc.ss}); and/or
a generic reduction in transmission probability (\x{art/n.dx.bc.gen}).
\par
Dropout from treatment, was simulated in \x{art/n.art.fail.any} articles, including:
\x{art/n.art.x.drop} using a separate compartment;
\x{art/n.art.r.drop} using a flow back into a generic ``off-treatment'' HIV state; and again
\x{art/n.art.r.frop} in which a similar flow was not clearly identified as treatment failure vs dropout.
% ------------------------------------------------------------------------------
